...
if(! defined('FILE_CACHE_MAX_FILE_AGE') )       define ('FILE_CACHE_MAX_FILE_AGE', 60*60*24*30);        // How old does a file have to be to be deleted from the cache
...
//Browser caching
if(! defined('BROWSER_CACHE_MAX_AGE') )         define ('BROWSER_CACHE_MAX_AGE', 60*60*24*30);        // Time to cache in the browser
